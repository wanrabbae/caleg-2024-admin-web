    ...
    <div class="w-full">
        <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-center min-vh-100 flex-column p-4">
                    ...
                    <h1 class="font-weight-lighter font-bold text-dark text-center">CALEG</h1>
                    @if ($errors->any())
                    ...
                    @endif
                    <form method="POST" action="{{ asset("authenticate") }}">
                        @csrf
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <span class="text-primary">
                    Maaf, masa waktu demo anda sudah habis. Silahkan klik invoice jika ingin lanjut berlangganan
                </span>
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            <form action="{{ asset("invoice") }}" method="POST">
                @csrf
                <input type="hidden" name="id_caleg" value="{{ session()->get('invoice') }}">
