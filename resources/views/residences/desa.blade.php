    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <div>
              ...
              <input type="hidden" name="search" class="form-control" id="search" value="{{ request("search") }}" pattern="[a-zA-Z0-9@\s]+">
              @endif
              <span class="d-block">Data Per Page</span>
                <input type="number" name="paginate" id="paginate" class="form-control" list="paginates" value="{{ request("paginate") }}">
            ...
            <div>
                ...
                <input type="hidden" name="paginate" class="form-control" id="paginate" list="paginates" value="{{ request("paginate") }}">
                @endif
                <span class="d-block">Search</span>
                <input type="text" name="search" id="search" class="form-control" value="{{ request("search") }}" pattern="[a-zA-Z0-9@\s]+">
                </form>
            </div>
          </div>
            {{ $dataArr->links() }}
