    ...
    <div class="book">
        <div class="page">
            <div class="subpage">
                ...
                <hr>
                <h3 style="color:black; font-family: sans;" align="center">LAPORAN JURNAL UMUM</h3>
                        ...
                        <table class="table" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ date("d F Y", strtotime($data->tgl_transaksi)) }}</td>
                                        <td>{{ $data->kategori->nama_kategori }}</td>
                                        <td></td>
                                        @if ($data->kategori->jenis_transaksi == "Pemasukan")
                                        <td style="text-align: left">Rp.{{ number_format($data->jumlah,2,',','.') }}</td>
                                        <td>Rp.0</td>
                                        @else
                                        <td>Rp.0</td>
                                        <td style="text-align: left">Rp.{{ number_format($data->jumlah,2,',','.') }}</td>
